...
CREATE OR REPLACE INDEX task_assigneeId_idx ON task(assigneeId);
CREATE OR REPLACE INDEX task_status_idx ON task(currentStatus);
CREATE OR REPLACE INDEX task_priority_idx ON task(priority);