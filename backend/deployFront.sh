...
sed -i "s|%DOCKER_REGISTRY_FRONT%|${DOCKER_REGISTRY_FRONT}|g" orabot-compose-$CURRENTTIME.yaml

sed -e "s|%DOCKER_REGISTRY_FRONT%|${DOCKER_REGISTRY_FRONT}|g" orabot-compose-${CURRENTTIME}.yaml > /tmp/orabot-compose-${CURRENTTIME}.yaml
