...
// import
// com.talentpentagon.javabot.commandhandlers.EditTaskStatusCommandHandler;
...
// @Test
// public void
// editTaskStatusCommandHandler_validTaskStatusChange_returnSuccess() {
...
// Mockito.when(taskService.updateTaskStatus(task.getId(), task.getStatus(),
// task.getStatusChangeDate()))
// .thenReturn(new ResponseEntity<>(HttpStatus.OK));

// ResponseEntity<TaskItem> response =
// editTaskStatusCommandHandler.execute(task);
