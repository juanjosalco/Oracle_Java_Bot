    ...
    <>
      ...
      <div className="base-container">
        <div className="terms-container">
          ...
          <p>Last updated: May 22, 2024</p><br/>
          ...
          <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the Privacy Policy Generator.</p><br/>
          ...
          <div className="section">
            ...
            <ul>
                ...
                <li><strong>Application</strong> refers to OraBot, the software program provided by the Company.</li>
                <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Talent-Pentagon, Av. Gral Ramón Corona No 2514, Colonia Nuevo México, 45201 Zapopan, Jal..</li>
          ...
          <div className="section">
            ...
            <ul>
                <li>By email: itdepartmentoraclebot@hotmail.com</li>
            </ul>
          </div>
