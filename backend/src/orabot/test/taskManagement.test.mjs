...
describe('create task', function() {
    ...
    it('should edit a test task', async function () {
        let driver = await new Builder().forBrowser(Browser.CHROME).build();
        await driver.get('https://team16.kenscourses.com/');
        await driver.findElement(By.xpath('//*[@id="root"]/div/div[2]/form/div/input[1]')).sendKeys('test@test.com');
        await driver.findElement(By.xpath('//*[@id="root"]/div/div[2]/form/div/input[2]')).sendKeys('test123');
        ...
        let task = await driver.findElement(By.xpath('//*[@id="root"]/div/div[last()]'));
        await task.findElement(By.xpath('..//div/div[2]/div[1]/div/a/img')).click();

        await driver.sleep(1000);

        await driver.findElement(By.xpath('//*[@id="root"]/div/div[2]/input')).sendKeys('Test task 123');
        await driver.sleep(2000);
        await driver.findElement(By.xpath('//*[@id="root"]/div/div[2]/div[5]/div[1]/button[2]')).click();
        await driver.sleep(2000);
    ...
    it('should delete a test task', async function () {
        ...
        await driver.findElement(By.xpath('//*[@id="root"]/div/div[2]/div[5]/div[2]/button')).click();
        await driver.sleep(500);
        await driver.findElement(By.xpath('//*[@id="root"]/div/div[2]/div/button[2]')).click();
        await driver.sleep(2000);
        const text = await driver.findElement(By.xpath('//*[@id="root"]/div/div[2]/h1')).getText();
        assert.isTrue(text.includes('these are your tasks'));
